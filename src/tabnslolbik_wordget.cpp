...
int main(int argc, char *argv[])
{
	...
	if(argc!=9)
	{
		puts("Sintax: 1char input_file, 2char output_file 3int no. of_stolbik_nomer 4char list_nomerov_stolbikov,razdelenie-zapyataya 5char list_words_in_strings 6int match type(1 exact coincidence, 0 only occurrence 7int contain_type(0 no 1 yes) 8int logic (1 AND 0 OR");
		exit(1);
	}
	strcpy(filei,argv[1]);//in_file
	strcpy(fileo,argv[2]);//out_file
	...
	char strnum[10000], strword[10000], value[10000];

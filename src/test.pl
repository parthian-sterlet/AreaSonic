...
my ($cmd, $i, $file1, $file2, $file_out_txt, $file_out_dist, $iter, $genome, $nchr, $ext_len, $ext_nam);

$file1           =$ARGV[0];  #track 1
$file2           =$ARGV[1];  #track 2
$genome          =$ARGV[2];  #genome mm, hg, at, dm
$iter            =$ARGV[3];  #number of iterations
$file_out_txt    =$ARGV[4];  #output file text
$file_out_dist   =$ARGV[5];  #output file distribution
